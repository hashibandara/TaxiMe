                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="addAccident" method="post">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-6 mb-3 mb-sm-0"><input class="form-control form-control-user" type="text" id="exampleInputEmail"  placeholder="Location" name="Location" style="border-radius: 0px;width: 308px;" required="required"></div>
                                    </div>
                                <div class="mb-3"></div>
                                <div class="row mb-3">
                                    <div class="col-sm-6 mb-3 mb-sm-0"><label class="form-label">Time</label><input class="form-control" type="time" style="border-radius: 0px;" name="time" required="required"><label class="form-label">Date</label><input class="form-control" type="date" name="date" style="border-radius: 0px;" required="required"></div>
