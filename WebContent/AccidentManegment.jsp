    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <h3 class="text-dark mb-4">Accident Coverage Manegment</h3>
                <div class="container">
                    <div class="row">
                        <div class="col"><a href="AccedentCoverage.jsp"><button class="btn btn-primary" type="button" style="margin-bottom: 29px;">Add New Record</button></a></div>
                    </div>
                </div>
                    ...
                    <div class="modal-body">
                        <div class="col-md-12">
                            <form class="user">
                                ...
                                <hr><button class="btn btn-primary d-block btn-user w-100" type="submit" style="border-radius: 0px;border-color: var(--bs-orange);background: var(--bs-orange);width: 50px;">Edit</button>
                                <hr>
                            </form>
                        </div>
                    </div>
