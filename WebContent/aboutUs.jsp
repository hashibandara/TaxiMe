...
<%@page import="com.taxiMe.utill.utill"%>
            ...
            <div id="content" style="background: var(--bs-light);">
                ...
                <div class="container-fluid" style="background: #ffffff;">
                    ...
                    <div class="row jello animated">
                        <div class="col d-xxl-flex justify-content-xxl-center align-items-xxl-center"><img class="d-xxl-flex justify-content-xxl-center align-items-xxl-center" src="assets/img/1.png" style="width: 25%;"></div>
                    </div>
                </div>
                <div class="row" style="margin-top: 9px;">
                    <div class="col">
                        <div class="card">
                            <div class="card-body" data-aos="fade-up" style="text-align: center;">
                                <h4 class="card-title" style="text-align: center;"><i class="fa fa-road" style="color: var(--bs-orange);font-size: 100px;text-shadow: 6px 6px 14px var(--bs-gray-dark);"></i></h4>
                                <h4 class="card-title">Travel any ware&nbsp;</h4>
                                <h4 class="card-title" style="text-align: center;"></h4>
                                <p class="card-text">Need travel&nbsp; but no vehicle do not warry travel any ware using our vehicles</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card">
                            <div class="card-body" data-aos="fade-up" style="text-align: center;">
                                <h4 class="card-title" style="text-align: center;"><i class="fa fa-gear" style="color: var(--bs-orange);font-size: 100px;text-shadow: 6px 6px 14px var(--bs-gray);"></i></h4>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body" data-aos="fade-up" style="text-align: center;"><i class="fa fa-crosshairs" style="color: var(--bs-orange);font-size: 100px;text-shadow: 6px 6px 14px var(--bs-gray);"></i>
                                <h4 class="card-title">Locational&nbsp;</h4>
                                <p class="card-text">Get vehicle to your location no need to warry set location and enjoy your journey</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col" data-aos="fade-up">
                            ...
                            <div class="row bg-dark">
                                ...
                                <hr> 
                                    ...
                                    <heading style="font-size:27px;text-align:center;">Tell us your expirence</heading>
                                    <div class="row">
                                    <div class="rate col-md-12 ">
									  ...
									  <div class="col input-group" style=""padding-left:20px;margin-left:50px;">
									  	<textarea name ="des" class="form-control" placeholder="Enter your expirence...." rows="5" required="required"></textarea>
									  </div>
									  </div>
                                    ...
                                    <div class="col" style="height:300px;">
                                        <div class="card" style="height:250px;" >
                                            <div class="card-body rating-box" >
                                                <h4 class="card-title" style="text-align: center;"></h4>
                                               <center><img src="assets/img/1.png" width="10%"></center>
                            ...
                            <div class="carousel-item ">
                                <div class="row" style="background: var(--bs-gray-dark);padding-top: 9px;padding-bottom: 28px;"style="height:300px;"> 
                                    <div class="col" style="height:300px; width: 80%">
                                        <div class="card" style="height:250px;">
                                            <div class="card-body">
                                            <center><img src="assets/img/1.png" width="8%"></center>
