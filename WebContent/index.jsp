            ...
            <div id="content" style="background: var(--bs-light);">
                ...
                <div class="container-fluid" style="background: #ffffff;">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4" style="padding-top: 33px;">
                        ...
                        <a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" href="report.jsp" style="color: var(--bs-light);background: var(--bs-orange);border-style: none;border-color: var(--bs-orange);"><i class="fas fa-download fa-sm text-white-50"></i>&nbsp;Generate Report</a>
                   		<%} %>
                    </div>
