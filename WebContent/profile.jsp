                                    ...
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body">
                                              <form class="user" action="employeeProfileUpdate" method="post">
				                                <div class="row mb-3">
				                                    <div class="col-sm-6 mb-3 mb-sm-0"><input class="form-control form-control-user" type="text" id="exampleFirstName-1" placeholder="First Name" name="fName" style="border-radius: 0px;" required="required" value="<%=employee.getName()%>"></div>
				                                   </div>
