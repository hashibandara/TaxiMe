...
<% User user = (User)session.getAttribute("user"); %>
    ...
    <div id="map"></div>
                        ...
                        <div class="col-md-12">
                            <form class="user" action="addReservation" method="post">
                                ...
                                <div class="row mb-3 p"   >
                                 <hr>
      								<div class="col-sm-6  " >
                                    <button class="btn btn-primary d-block btn-user w-100" type="submit" style="border-radius: 0px;border-color: var(--bs-orange);background: var(--bs-orange);width: 50px;">Add</button>
                                </div>
     ...
     <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDG2cWFrwfTw_qjcv8tNXgikSXDYEEwl0s&callback=pickMap&libraries=places&v=weekly"></script>
