                        ...
                        <div class="p-5">
                            ...
                            <form class="user" action="addMaintain" method="post">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-6"><input class="form-control form-control-user" type="text" id="exampleFirstName-2" placeholder="Status" name="status" style="border-radius: 0px;" required="required"></div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-6 mb-3 mb-sm-0"><input class="form-control form-control-user" type="number" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="QTY" name="qty" style="border-radius: 0px;width: 308px;" required="required"></div>
                                    <div class="col-sm-6"><input class="form-control form-control-user" type="number" id="exampleFirstName-2" placeholder="Part ID" name="part_id" style="border-radius: 0px;" required="required"></div>
                                </div>
                                <div class="mb-3"></div>
                                <div class="row mb-3">
                                    <div class="col-sm-6 mb-3 mb-sm-0"  ><label class="form-label">Date</label><input class="form-control" type="date" name="date" style="border-radius: 0px;" required="required"></div>
                                ...
                                <hr><button class="btn btn-primary d-block btn-user w-100" type="submit" style="border-radius: 0px;background: var(--bs-orange);border-color: var(--bs-orange);width: 527px;margin-bottom: 7px;">Submit</button><a href="VehicleMaintainesManegment.jsp" class="btn btn-primary d-block btn-user w-100" type="submit" style="border-radius: 0px;background: var(--bs-blue);border-color: var(--bs-blue);">View Table</a>
                                <hr>
                            </form>
