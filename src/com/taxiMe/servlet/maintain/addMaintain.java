...
/**
 * Servlet implementation class addMaintain
 */ 
public class addMaintain extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			isTrue = service.addMaintaine(maintaine);
			...
			if(isTrue == true) {
				...
				RequestDispatcher dispatcher = request.getRequestDispatcher("updateVehicleMaintaines.jsp");
				dispatcher.forward(request, response);
			}
